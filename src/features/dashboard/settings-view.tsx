...
import { Settings, ShieldCheck, Trash2, AlertTriangle } from "lucide-react";
...
export const SettingsView = ({ workspace, canDelete = true, onDeleteWorkspace }: SettingsViewProps) => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 select-none">
      <div>
        ...
        <p className="font-mono text-xs text-[#656467] uppercase tracking-wider">
          Configuration // System Preferences
        </p>
      </div>

      <div className="bg-white dark:bg-[#09090B] p-8 border border-[#E4E4E7] dark:border-[#27272A] shadow-sm dark:shadow-none space-y-6">
        ...
        <div className="pt-4 border-t border-[#E4E4E7] dark:border-[#18181B] flex items-center justify-between">
          <div className="flex items-center gap-x-2 text-xs font-mono text-[#656467] uppercase">
      ...
      <div className="bg-rose-50/50 dark:bg-[#09090B] p-8 border border-rose-200 dark:border-rose-900/30 shadow-sm dark:shadow-none space-y-4">
        ...
        <button
          ...
          className="bg-rose-600 hover:bg-rose-700 text-white dark:bg-rose-950/40 dark:border dark:border-rose-500/40 dark:text-rose-400 dark:hover:bg-rose-600 dark:hover:text-white font-mono text-xs uppercase px-5 py-2.5 transition-colors font-bold flex items-center gap-x-2 cursor-pointer rounded-none shadow-sm"
        >
